<template>
  <div class="col-10 offset-md2 container">
    ...
    <table class="table col-10 offset-md-2" >
      ...
      <tbody>
        <tr> <!--<tr :v-for="usuarios in usuario" :key="usuarios">-->
          ...
          <td>maurici@boxti.com.br</td>
          <td>03/03/2021 às 09:30:00</td>
          <td>            
            <a href="#" class="icon1" @click.prevent="removeUsers(usuario.id)"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
</svg></a>
            &emsp;
            <router-link to="/"><a href="#" class="icon2"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
